    ...
    <head>
        <script type="application/ld+json">
        {
         ...
         "@type": "Person",
         "name": "冠恩",
         "alternateName": ["卢鸿凯","Mr Gauen","GuanEn"],
         "url": "https://guanen.top",
         "sameAs": [
           "https://www.douyin.com/user/MS4wLjABAAAADxE4AzD9LlrFlq6_0fPKa04OjgF0Husz5PfMXLTLZug"
         ]
        }
        </script>
        <script>
...
<meta name="description" content="冠恩先生（Mr.Gauen）生活远比戏剧更荒诞与沉重，但荒诞不是让我们绝望，而是让我们重新滋生勇气与信心">
<meta name="keywords" content="冠恩先生,Mr Gauen,冠恩,个人官网,作品集,冠恩书屋，冠恩超人">
<meta name="author" content="冠恩先生">
        ...
        <script src="assets/js/hello-animation.js"defer></script>
        
        <!-- 外部库集成：React 框架及其 DOM 渲染库，Lucide 图标库 (本地化加载) -->
        <!-- 核心库加载 -->
        <script src="assets/vendor/react.min.js"defer></script>
        <script src="assets/vendor/react-dom.min.js"defer></script>
        <script>
            /**
             * 核心库初始化
        ...
        <script src="assets/vendor/lucide-react.min.js"defer></script>
        <script>
            /**
             * 图标库加载后的容错处理
        ...
        <link rel="stylesheet" href="assets/css/pages.css" media="print" onload="this.media='all'">         <!-- 各页面通用布局样式 -->
        <link rel="stylesheet" href="assets/css/page-loading.css">   <!-- 页面加载动画专用样式 -->
        <link rel="stylesheet" href="assets/css/chat.css" media="print" onload="this.media='all'">          <!-- 聊天室/客服组件样式 -->
        <!-- 引入 FontAwesome CDN -->
    ...
    * { margin:0; padding:0; box-sizing:border-box;}
    ...
    <button class="menu-btn" onclick="window.location.href='pages/shop.php'">文创小铺</button>
    <button class="menu-btn" id="lotteryBtn">抽奖</button>
    <button class="menu-btn" id="aiChatBtn">AI 书童</button>
    ...
    <button class="menu-btn" id="loginBtn"><?php echo core_is_logged_in() ? '用户中心' : '登录'; ?></button>
        ...
        <div class="fullscreen" id="topSection">
            <div class="title-container">
                <h1 class="main-title" id="mainTitle">想象另一种可能</h1>
                
                <div class="welcome-container" id="welcomeContainer">
                    <div class="welcome-text" id="welcomeText">冠恩先生欢迎您</div>
                </div>
            </div>
